...
class AVPConfig {
  ...
  Map convertToMap() {
    ...
    if (this.mSelectTrackBufferMode != null) {
      map.addAll({"mSelectTrackBufferMode":this.mSelectTrackBufferMode});
    }
    return map;
  }
  ...
  static AVPConfig convertAt(Map map) {
    ...
    config.mSelectTrackBufferMode = map["mSelectTrackBufferMode"];
    return config;
  }
}
